var tipo_modalidad_pago_table = null

jQuery(document).ready(function () {
    tipo_modalidad_pago_table = $('#table-tipo-modalidad-pago')
    dataTablesInit(tipo_modalidad_pago_table, {
        ajax: __HOMEPAGE_PATH__ + 'tipo_modalidad_pago/index_table/',
    ...
    $(document).on('click', '.accion-habilitar', function (e) {
        ...
        show_confirm({
            title: 'Confirmación',
            type: 'warning',
            msg: '¿Desea '+ msg +' esta modalidad de pago?',
            callbackOK: function () {
