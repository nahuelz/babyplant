var solucion_table = null

jQuery(document).ready(function () {
    solucion_table = $('#table-solucion')
    dataTablesInit(solucion_table, {
        ajax: __HOMEPAGE_PATH__ + 'tipo/solucion/index_table/',
    ...
    $(document).on('click', '.accion-habilitar', function (e) {
        ...
        show_confirm({
            title: 'Confirmación',
            type: 'warning',
            msg: '¿Desea '+ msg +' este tipo solucion?',
            callbackOK: function () {
