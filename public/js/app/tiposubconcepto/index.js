var subconcepto_table = null

jQuery(document).ready(function () {
    subconcepto_table = $('#table-sub-concepto')
    dataTablesInit(subconcepto_table, {
        ajax: __HOMEPAGE_PATH__ + 'tipo/sub/concepto/index_table/',
    ...
    $(document).on('click', '.accion-habilitar', function (e) {
        ...
        show_confirm({
            title: 'Confirmación',
            type: 'warning',
            msg: '¿Desea '+ msg +' este tipo subconcepto?',
            callbackOK: function () {
