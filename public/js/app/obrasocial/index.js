var obra_social_table = null

jQuery(document).ready(function () {
    obra_social_table = $('#table-obra-social')
    dataTablesInit(obra_social_table, {
        ajax: __HOMEPAGE_PATH__ + 'obra_social/index_table/',
    ...
    $(document).on('click', '.accion-habilitar', function (e) {
        ...
        show_confirm({
            title: 'Confirmación',
            type: 'warning',
            msg: '¿Desea '+ msg +' esta obra social?',
            callbackOK: function () {
