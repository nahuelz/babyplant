var sub_producto_table = null

jQuery(document).ready(function () {
    sub_producto_table = $('#table-sub_producto')
    dataTablesInit(sub_producto_table, {
        ajax: __HOMEPAGE_PATH__ + 'tipo/sub/producto/index_table/',
    ...
    $(document).on('click', '.accion-habilitar', function (e) {
        ...
        show_confirm({
            title: 'Confirmación',
            type: 'warning',
            msg: '¿Desea '+ msg +' este tipo sub_producto?',
            callbackOK: function () {
