var concepto_table = null

jQuery(document).ready(function () {
    concepto_table = $('#table-concepto')
    dataTablesInit(concepto_table, {
        ajax: __HOMEPAGE_PATH__ + 'tipo/concepto/index_table/',
    ...
    $(document).on('click', '.accion-habilitar', function (e) {
        ...
        show_confirm({
            title: 'Confirmación',
            type: 'warning',
            msg: '¿Desea '+ msg +' este tipo concepto?',
            callbackOK: function () {
