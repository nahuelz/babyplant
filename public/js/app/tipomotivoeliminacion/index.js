var motivo_eliminacion_table = null

jQuery(document).ready(function () {
    motivo_eliminacion_table = $('#table-motivo-eliminacion')
    dataTablesInit(motivo_eliminacion_table, {
        ajax: __HOMEPAGE_PATH__ + 'tipo/motivo/eliminacion/index_table/',
    ...
    $(document).on('click', '.accion-habilitar', function (e) {
        ...
        show_confirm({
            title: 'Confirmación',
            type: 'warning',
            msg: '¿Desea '+ msg +' este motivo eliminacion?',
            callbackOK: function () {
