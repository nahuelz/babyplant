var origen_semilla_table = null

jQuery(document).ready(function () {
    origen_semilla_table = $('#table-origen_semilla')
    dataTablesInit(origen_semilla_table, {
        ajax: __HOMEPAGE_PATH__ + 'tipo/origen/semilla/index_table/',
    ...
    $(document).on('click', '.accion-habilitar', function (e) {
        ...
        show_confirm({
            title: 'Confirmación',
            type: 'warning',
            msg: '¿Desea '+ msg +' este tipo origen_semilla?',
            callbackOK: function () {
