var revision_table = null

jQuery(document).ready(function () {
    revision_table = $('#table-revision')
    dataTablesInit(revision_table, {
        ajax: __HOMEPAGE_PATH__ + 'tipo/revision/index_table/',
    ...
    $(document).on('click', '.accion-habilitar', function (e) {
        ...
        show_confirm({
            title: 'Confirmación',
            type: 'warning',
            msg: '¿Desea '+ msg +' este tipo revision?',
            callbackOK: function () {
